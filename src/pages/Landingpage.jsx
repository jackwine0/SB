  ...
  return (
    <div className="landingpage">
      ...
      <div className="landing-content">
        <div className="landcol1">
          <div className="landcol1-content">
            ...
            <button className="landsignin-button" onClick={handleSigninClick}>
      ...
      <div className="about-chart">
        <div className="AC1">
          <img
            src="https://res.cloudinary.com/duicyr28v/image/upload/v1722877112/SB_img3_jklwva.svg"
            alt="About Us"
          />
        </div>
        <div className="AC2">
        ...
        <div className="featured-col1">
          ...
          <div>
            ...
            <ul>
              ...
              <li>Create personal budgets to suit your spending and saving goals.</li>
            </ul>
          </div>
        </div>
